...
public class Intake extends SubsystemBase {
    ...
    public Intake(){
        ...
        //this.CANSparkMax3 = new CANSparkMax(Constants.INTAKE_MOTOR1_ID, MotorType.kBrushless);
        //this.CANSparkMax4 = new CANSparkMax(Constants.INTAKE_MOTOR2_ID, MotorType.kBrushless);
    ...
    public void spin(boolean forward){
        INTAKE_SPEED = SmartDashboard.getNumber("Intake Motor Speeds", 0.75);
        double speed = forward ? INTAKE_SPEED : INTAKE_SPEED*-1;
